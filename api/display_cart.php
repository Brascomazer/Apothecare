<?php
// We starten geen sessie hier omdat die al gestart is in de winkelwagen.php pagina
// We sluiten de database verbinding niet hier omdat die in de hoofdpagina wordt afgesloten
...
if (is_logged_in()) {
    ...
    echo "<tr><td colspan='4' style='text-align: center;'>Log in om je winkelwagen te bekijken</td></tr>";
}

// Let op: we sluiten de verbinding niet hier
// $conn->close();
?>